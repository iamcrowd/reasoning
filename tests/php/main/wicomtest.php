...
/**
Tests the main class and its methods.

@testdox Do the full reasoning.
...
class WicomTest extends PHPUnit\Framework\TestCase
{
    ...
    */
    ...
    //    public function
    //  test_full_reasoning_UML_BinaryAssocWithoutClass0N_CompareJSON(){
    //        $input = file_get_contents('main/data/full_reasoning_input.json');
    //        $expected =
    //  file_get_contents('main/data/full_reasoning_expected.json');
